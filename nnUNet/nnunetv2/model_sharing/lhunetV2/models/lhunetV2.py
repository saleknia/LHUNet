...
class LHUNetV2(nn.Module):
    def __init__(
        ...
        # ================================================ NEW
        hyb_att_cnn_blocks="d",  # d: dlka, l: lka, i: identity, a: cnn-attention | item 1
        hyb_att_vit_blocks="s",  # s: sequential, p: parallel | item 2
        ...
        # ================================================ NEW
        if not dec_hyb_att_cnn_blocks:
            dec_hyb_att_cnn_blocks = hyb_att_cnn_blocks[::-1]
        if not dec_hyb_att_vit_blocks:
            dec_hyb_att_vit_blocks = hyb_att_vit_blocks[::-1]
        # ================================================
        ...
        self.hyb_encoder = HybridEncoder(
            ...
            act_name=("leakyrelu", {"inplace": True, "negative_slope": 0.01}),
            # ================================================ NEW
            att_cnn_blocks=hyb_att_cnn_blocks,
            att_vit_blocks=hyb_att_vit_blocks,
            use_rb=use_rb,
            use_r=use_r,
            # ================================================
        )
        ...
        self.hyb_decoder = HybridDecoder(
            ...
            act_name=("leakyrelu", {"inplace": True, "negative_slope": 0.01}),
            # ================================================ NEW
            att_cnn_blocks=dec_hyb_att_cnn_blocks,
            att_vit_blocks=dec_hyb_att_vit_blocks,
            use_rb=use_rb,
            use_r=use_r,
            # ================================================
        )
