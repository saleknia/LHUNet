...
class HybridEncoder(BaseBlock, BaseHybridBlock):
    def __init__(
        ...
        # ===== TRACK STAGE NUMBER (stages 3, 4, 5) =====
        stage_counter = 3  # Start from stage 3 for hybrid blocks
        ...
        for (
                ...
                nn.Sequential(
                    *[
                        HybAttnBlock(
                            ...
                            use_rb=use_rb,
                            use_r=use_r,
                            stage_id=stage_counter,  # ← PASS STAGE ID
                            # ========================================
                        )
                        for _ in range(t_rp)
                    ]
            ...
            stage_counter += 1  # ← INCREMENT for next stage
...
class HybridDecoder(BaseBlock, BaseHybridBlock):
    def __init__(
        ...
        # ===== TRACK STAGE NUMBER FOR DECODER (stages 5, 4, 3 reversed) =====
        # Decoder stages go in reverse: stage 5, then stage 4, then stage 3
        stage_counter = 5  # Start from stage 5 (deepest)
        ...
        for (
            ...
            stage_counter -= 1  # ← DECREMENT for next stage (5→4→3)
